...
There is a version of build less, own more of the outcome that looks busy and a version that compounds. The difference is rarely a tool.
...
On build less, own more of the outcome, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
