...
I keep returning to a simple test: after a week of work on alignment is a protocol, not a meeting, can someone outside the room explain what changed and who owns it?
...
On alignment is a protocol, not a meeting, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
