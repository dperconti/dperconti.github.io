...
Quiet teams often get this right before loud ones do: the meeting you should replace with a doc is a system of habits, not a quarterly theme.
...
On the meeting you should replace with a doc, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
