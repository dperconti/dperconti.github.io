---
title: "Reorganizing when the product shape changes: what fails first"
...
Reorganizing when the product shape changes is design work. Meetings can choose among options. They cannot permanently store ownership.
...
If someone new cannot explain **Reorganizing when the product shape changes** from your artifacts in fifteen minutes, the practice is still private.
