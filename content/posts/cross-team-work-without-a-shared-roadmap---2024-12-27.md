...
“Cross-team work without a shared roadmap” stops being abstract the moment you ask who gets paged when it fails.
...
Write one page while the decision is still warm — context, options, choice, owner, revisit date. Verbal alignment on **Cross-team work without a shared roadmap** evaporates under ordinary calendar pressure, and Slack archaeology is a poor substitute for a decision record.

When pressure rises, teams drop the unowned practice first. Put **Cross-team work without a shared roadmap** in the path of work — templates, checklists, review norms — or admit it was optional applause.
...
On **Cross-team work without a shared roadmap**, keep the loop short: write the decision, name the owner, verify the outcome.
