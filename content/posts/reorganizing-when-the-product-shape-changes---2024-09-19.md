...
I keep returning to a simple test: after a week of work on reorganizing when the product shape changes, can someone outside the room explain what changed and who owns it?
...
On reorganizing when the product shape changes, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
