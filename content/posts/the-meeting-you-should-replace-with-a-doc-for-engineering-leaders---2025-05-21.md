...
The interesting constraint is not speed. It is whether the meeting you should replace with a doc for engineering leaders leaves the next person more capable.
...
On the meeting you should replace with a doc for engineering leaders, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
