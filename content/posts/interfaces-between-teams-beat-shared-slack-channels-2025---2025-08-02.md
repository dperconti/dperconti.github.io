---
title: "Interfaces between teams beat shared Slack channels: the operable version"
...
When people say they need better Interfaces between teams beat shared Slack channels, I look for missing contracts: who consumes what, what “done” means, and who gets paged when the joint system lies.
...
Resist the urge to expand scope into neighboring slogans. If a control does not make **Interfaces between teams beat shared Slack channels** more operable for the next person, leave it for another note. Dilution is how coherent essays become stitched scrapbooks.

For **Interfaces between teams beat shared Slack channels**, the inheritance test is blunt: after a week, can someone outside the original room explain what changed, who owns it, and how you will know if it breaks? If the answer depends on hallway memory, you still have a story — not a practice.
...
Write one page while the decision is still warm — context, options, choice, owner, revisit date. Verbal alignment on **Interfaces between teams beat shared Slack channels** evaporates under ordinary calendar pressure, and Slack archaeology is a poor substitute for a decision record.
...
On **Interfaces between teams beat shared Slack channels**, publish the interface: inputs, outputs, done criteria, and who gets paged. More Slack is not a substitute for a contract, and hero translators are a continuity risk.
...
If someone new cannot explain **Interfaces between teams beat shared Slack channels** from your artifacts in fifteen minutes, the practice is still private.
