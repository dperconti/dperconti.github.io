---
title: "Carbon-aware scheduling without the slogans in practice"
...
The interesting constraint is not speed. It is whether carbon-aware scheduling without the slogans in practice leaves the next person more capable.
...
On carbon-aware scheduling without the slogans in practice, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
