---
title: "Collaboration tax and how to cut it"
...
There is a version of collaboration tax and how to cut it that looks busy and a version that compounds. The difference is rarely a tool.
...
On collaboration tax and how to cut it, the leadership move is to make the invisible visible: ownership, verification, and the path for the next person.
